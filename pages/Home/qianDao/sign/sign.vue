	...
	export default {
		data() {
			return {
				...
				covers: [
					// 公司点信息
					{id:0,callout:{content:"阿甘科技有限公司",display:"ALWAYS",},latitude:43.83828,longitude:125.292083,iconPath: '../../static/img/location.png'},
				],
				circles:[
					// 公司圆信息
					// {latitude:43.83828,longitude:125.292083,radius:180,strokeWidth:1,fillColor:"#7fff0099"},    --------修改之前
					{latitude:43.83828,longitude:125.292083,radius:1080,strokeWidth:1,fillColor:"#7fff0099"},   //此位置管圈的范围000000000
				],
				controls:[
					// 控
